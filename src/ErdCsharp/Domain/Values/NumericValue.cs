...
namespace ErdCsharp.Domain.Values
{
    public class NumericValue : BaseBinaryValue
    {
        ...
        public static NumericValue BigIntValue(BigInteger value) => 
            new NumericValue(TypeValue.BigIntTypeValue, value);

        public static NumericValue TokenAmount(ESDTAmount value) => 
            new NumericValue(TypeValue.BigUintTypeValue, value.Value);
